...
<img src="assets/img/RM_model.pdf" width="750px"></img>
</div>
...
<div style='text-align:center;'>
<img src="assets/img/regression.pdf" width="750px"></img>
</div>
...
<div style='text-align:center;'>
<img src="assets/img/protected_areas.pdf" width="750px"></img>
</div>
...
- Finding roots of a rough parameter surface
- Optimize location of protected areas
...
<div style='text-align:center;'>
<img src="assets/img/polynomial.pdf" width="750px"></img>
</div>
...
For such a simple problem, we simply have to take the derivative and solve it for $dY/dX = 0$

---

# The problem to solve  

## But imagine if the surface looked like  

<div style='text-align:center;'>
<img src="assets/img/surface.pdf" width="750px"></img>
</div>
...
<div style='text-align:center;'>
<img src="assets/img/SA.pdf" width="750px"></img>
</div>
...
<div style='text-align:center;'>
$\theta_{t+1} = \theta_t + \delta$ with probability $\rho = exp(\Delta h/T_t)$
</div>

Or reject it: 

<div style='text-align:center;'>
$\theta_{t+1} = \theta_t$ with probability $1 - \rho$
</div>
...
## Imagine that you have to create a network of protected areas in a region where there is a metapopulation of an endangered frogs. You have a limited amount of money to buy only 20 out of the 100 remaining forest fragments where the species could occur. Which one would you pick ? 

<div style='text-align:center;'>
<img src="assets/img/spatial_network.pdf" width="750px"></img>
</div>
